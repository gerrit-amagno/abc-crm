...
${nuget_cmd} install src/AmagnoWebApi.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AmagnoWebApi.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AmagnoWebApi.Client.dll \
-recurse:'src/AmagnoWebApi.Client/*.cs' \
-doc:bin/AmagnoWebApi.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AmagnoWebApi.Client.dll was created successfully"
fi
