...
namespace AmagnoWebApi.Client.Api
{
    ...
    /// </summary>
    public interface IUserGroupMembersApi : IApiAccessor
    {
        ...
        /// <param name="memberId">GUID of the user group member</param>
        ...
        ApiResponse<Object> UserGroupMembersDeleteWithHttpInfo (Guid memberId, string authorization);
        /// <summary>
        ...
        /// <param name="memberId">GUID of the user group member</param>
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>UserGroupMember</returns>
        ...
        /// <param name="memberId">GUID of the user group member</param>
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of UserGroupMember</returns>
        ApiResponse<UserGroupMember> UserGroupMembersGetWithHttpInfo (Guid memberId, string authorization);
        ...
        System.Threading.Tasks.Task<Object> UserGroupMembersDeleteAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UserGroupMembersDeleteWithHttpInfoAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns the requested user group member
        /// </summary>
        /// <remarks>
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UserGroupMember</returns>
        System.Threading.Tasks.Task<UserGroupMember> UserGroupMembersGetAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UserGroupMember)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserGroupMember>> UserGroupMembersGetWithHttpInfoAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UserGroupMembersApi : IUserGroupMembersApi
    {
        private AmagnoWebApi.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupMembersApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UserGroupMembersApi(String basePath)
        {
        ...
        /// <returns></returns>
        public UserGroupMembersApi(AmagnoWebApi.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>Object</returns>
        public Object UserGroupMembersDelete (Guid memberId, string authorization)
        {
             ApiResponse<Object> localVarResponse = UserGroupMembersDeleteWithHttpInfo(memberId, authorization);
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse<Object> UserGroupMembersDeleteWithHttpInfo (Guid memberId, string authorization)
        {
            // verify the required parameter 'memberId' is set
            if (memberId == null)
                throw new ApiException(400, "Missing required parameter 'memberId' when calling UserGroupMembersApi->UserGroupMembersDelete");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling UserGroupMembersApi->UserGroupMembersDelete");

            var localVarPath = "/user-group-members/{memberId}";
            ...
            {
                Exception exception = ExceptionFactory("UserGroupMembersDelete", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> UserGroupMembersDeleteAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Object> localVarResponse = await UserGroupMembersDeleteWithHttpInfoAsync(memberId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UserGroupMembersDeleteWithHttpInfoAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'memberId' is set
            if (memberId == null)
                throw new ApiException(400, "Missing required parameter 'memberId' when calling UserGroupMembersApi->UserGroupMembersDelete");
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>UserGroupMember</returns>
        public UserGroupMember UserGroupMembersGet (Guid memberId, string authorization)
        {
             ApiResponse<UserGroupMember> localVarResponse = UserGroupMembersGetWithHttpInfo(memberId, authorization);
             return localVarResponse.Data;
        }
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of UserGroupMember</returns>
        public ApiResponse<UserGroupMember> UserGroupMembersGetWithHttpInfo (Guid memberId, string authorization)
        {
            // verify the required parameter 'memberId' is set
            if (memberId == null)
                throw new ApiException(400, "Missing required parameter 'memberId' when calling UserGroupMembersApi->UserGroupMembersGet");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling UserGroupMembersApi->UserGroupMembersGet");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UserGroupMembersGet", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<UserGroupMember>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (UserGroupMember) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UserGroupMember)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UserGroupMember</returns>
        public async System.Threading.Tasks.Task<UserGroupMember> UserGroupMembersGetAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UserGroupMember> localVarResponse = await UserGroupMembersGetWithHttpInfoAsync(memberId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UserGroupMember)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserGroupMember>> UserGroupMembersGetWithHttpInfoAsync (Guid memberId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'memberId' is set
            if (memberId == null)
                throw new ApiException(400, "Missing required parameter 'memberId' when calling UserGroupMembersApi->UserGroupMembersGet");
