...
namespace AmagnoWebApi.Client.Api
{
    ...
    public interface ITagGroupsApi : IApiAccessor
    {
        ...
        /// <param name="tagGroupId">GUID of the tag group</param>
        ...
        ApiResponse<TagGroup> TagGroupsGetTagGroupWithHttpInfo (Guid tagGroupId, string authorization);
        /// <summary>
        ...
        ApiResponse<TagCollections> TagGroupsGetTagGroupTagsWithHttpInfo (Guid tagGroupId, string authorization);
        ...
        System.Threading.Tasks.Task<TagGroup> TagGroupsGetTagGroupAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TagGroup>> TagGroupsGetTagGroupWithHttpInfoAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns all tags in the tag group
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TagCollections> TagGroupsGetTagGroupTagsAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TagCollections>> TagGroupsGetTagGroupTagsWithHttpInfoAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class TagGroupsApi : ITagGroupsApi
    {
        ...
        /// <returns></returns>
        public TagGroupsApi(AmagnoWebApi.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>TagGroup</returns>
        public TagGroup TagGroupsGetTagGroup (Guid tagGroupId, string authorization)
        {
             ApiResponse<TagGroup> localVarResponse = TagGroupsGetTagGroupWithHttpInfo(tagGroupId, authorization);
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of TagGroup</returns>
        public ApiResponse<TagGroup> TagGroupsGetTagGroupWithHttpInfo (Guid tagGroupId, string authorization)
        {
            // verify the required parameter 'tagGroupId' is set
            if (tagGroupId == null)
                throw new ApiException(400, "Missing required parameter 'tagGroupId' when calling TagGroupsApi->TagGroupsGetTagGroup");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling TagGroupsApi->TagGroupsGetTagGroup");

            var localVarPath = "/tag-groups/{tagGroupId}";
            ...
            if (tagGroupId != null) localVarPathParams.Add("tagGroupId", this.Configuration.ApiClient.ParameterToString(tagGroupId)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("TagGroupsGetTagGroup", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<TagGroup>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (TagGroup) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TagGroup)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TagGroup</returns>
        public async System.Threading.Tasks.Task<TagGroup> TagGroupsGetTagGroupAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TagGroup> localVarResponse = await TagGroupsGetTagGroupWithHttpInfoAsync(tagGroupId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TagGroup)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TagGroup>> TagGroupsGetTagGroupWithHttpInfoAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'tagGroupId' is set
            if (tagGroupId == null)
                throw new ApiException(400, "Missing required parameter 'tagGroupId' when calling TagGroupsApi->TagGroupsGetTagGroup");
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>TagCollections</returns>
        public TagCollections TagGroupsGetTagGroupTags (Guid tagGroupId, string authorization)
        {
             ApiResponse<TagCollections> localVarResponse = TagGroupsGetTagGroupTagsWithHttpInfo(tagGroupId, authorization);
             return localVarResponse.Data;
        }
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of TagCollections</returns>
        public ApiResponse<TagCollections> TagGroupsGetTagGroupTagsWithHttpInfo (Guid tagGroupId, string authorization)
        {
            // verify the required parameter 'tagGroupId' is set
            if (tagGroupId == null)
                throw new ApiException(400, "Missing required parameter 'tagGroupId' when calling TagGroupsApi->TagGroupsGetTagGroupTags");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling TagGroupsApi->TagGroupsGetTagGroupTags");

            var localVarPath = "/tag-groups/{tagGroupId}/tags";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("TagGroupsGetTagGroupTags", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TagCollections</returns>
        public async System.Threading.Tasks.Task<TagCollections> TagGroupsGetTagGroupTagsAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TagCollections> localVarResponse = await TagGroupsGetTagGroupTagsWithHttpInfoAsync(tagGroupId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TagCollections)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TagCollections>> TagGroupsGetTagGroupTagsWithHttpInfoAsync (Guid tagGroupId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'tagGroupId' is set
            if (tagGroupId == null)
                throw new ApiException(400, "Missing required parameter 'tagGroupId' when calling TagGroupsApi->TagGroupsGetTagGroupTags");
