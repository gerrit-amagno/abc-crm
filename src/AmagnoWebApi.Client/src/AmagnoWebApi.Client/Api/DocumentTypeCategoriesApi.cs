...
namespace AmagnoWebApi.Client.Api
{
    ...
    /// </summary>
    public interface IDocumentTypeCategoriesApi : IApiAccessor
    {
        ...
        /// <param name="documentTypeCategoryId">GUID of the document type category</param>
        ...
        ApiResponse<List<DocumentType>> DocumentTypeCategoriesGetDocumentTypesWithHttpInfo (Guid documentTypeCategoryId, string authorization);
        ...
        System.Threading.Tasks.Task<List<DocumentType>> DocumentTypeCategoriesGetDocumentTypesAsync (Guid documentTypeCategoryId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<DocumentType>>> DocumentTypeCategoriesGetDocumentTypesWithHttpInfoAsync (Guid documentTypeCategoryId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DocumentTypeCategoriesApi : IDocumentTypeCategoriesApi
    {
        private AmagnoWebApi.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTypeCategoriesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DocumentTypeCategoriesApi(String basePath)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public DocumentTypeCategoriesApi()
        {
        ...
        /// <returns></returns>
        public DocumentTypeCategoriesApi(AmagnoWebApi.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>List&lt;DocumentType&gt;</returns>
        public List<DocumentType> DocumentTypeCategoriesGetDocumentTypes (Guid documentTypeCategoryId, string authorization)
        {
             ApiResponse<List<DocumentType>> localVarResponse = DocumentTypeCategoriesGetDocumentTypesWithHttpInfo(documentTypeCategoryId, authorization);
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of List&lt;DocumentType&gt;</returns>
        public ApiResponse<List<DocumentType>> DocumentTypeCategoriesGetDocumentTypesWithHttpInfo (Guid documentTypeCategoryId, string authorization)
        {
            // verify the required parameter 'documentTypeCategoryId' is set
            if (documentTypeCategoryId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeCategoryId' when calling DocumentTypeCategoriesApi->DocumentTypeCategoriesGetDocumentTypes");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling DocumentTypeCategoriesApi->DocumentTypeCategoriesGetDocumentTypes");

            var localVarPath = "/document-type-categories/{documentTypeCategoryId}/document-types";
            ...
            if (documentTypeCategoryId != null) localVarPathParams.Add("documentTypeCategoryId", this.Configuration.ApiClient.ParameterToString(documentTypeCategoryId)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("DocumentTypeCategoriesGetDocumentTypes", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;DocumentType&gt;</returns>
        public async System.Threading.Tasks.Task<List<DocumentType>> DocumentTypeCategoriesGetDocumentTypesAsync (Guid documentTypeCategoryId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<DocumentType>> localVarResponse = await DocumentTypeCategoriesGetDocumentTypesWithHttpInfoAsync(documentTypeCategoryId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;DocumentType&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DocumentType>>> DocumentTypeCategoriesGetDocumentTypesWithHttpInfoAsync (Guid documentTypeCategoryId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'documentTypeCategoryId' is set
            if (documentTypeCategoryId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeCategoryId' when calling DocumentTypeCategoriesApi->DocumentTypeCategoriesGetDocumentTypes");
