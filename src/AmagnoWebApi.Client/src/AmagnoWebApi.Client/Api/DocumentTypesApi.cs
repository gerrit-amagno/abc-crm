...
namespace AmagnoWebApi.Client.Api
{
    ...
    public interface IDocumentTypesApi : IApiAccessor
    {
        ...
        /// <param name="documentTypeId">GUID of the document type</param>
        ...
        ApiResponse<List<TagGroupDefinition>> DocumentTypesGetWithHttpInfo (Guid documentTypeId, string authorization);
        /// <summary>
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of List&lt;TagGroupDefinition&gt;</returns>
        ApiResponse<List<TagGroupDefinition>> DocumentTypesGetTagGroupDefinitionsWithHttpInfo (Guid documentTypeId, string authorization);
        ...
        System.Threading.Tasks.Task<List<TagGroupDefinition>> DocumentTypesGetAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<TagGroupDefinition>>> DocumentTypesGetWithHttpInfoAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns all of the tag groups related to the document type
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;TagGroupDefinition&gt;</returns>
        System.Threading.Tasks.Task<List<TagGroupDefinition>> DocumentTypesGetTagGroupDefinitionsAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;TagGroupDefinition&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<TagGroupDefinition>>> DocumentTypesGetTagGroupDefinitionsWithHttpInfoAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DocumentTypesApi : IDocumentTypesApi
    {
        ...
        /// <returns></returns>
        public DocumentTypesApi(AmagnoWebApi.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>List&lt;TagGroupDefinition&gt;</returns>
        public List<TagGroupDefinition> DocumentTypesGet (Guid documentTypeId, string authorization)
        {
             ApiResponse<List<TagGroupDefinition>> localVarResponse = DocumentTypesGetWithHttpInfo(documentTypeId, authorization);
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of List&lt;TagGroupDefinition&gt;</returns>
        public ApiResponse<List<TagGroupDefinition>> DocumentTypesGetWithHttpInfo (Guid documentTypeId, string authorization)
        {
            // verify the required parameter 'documentTypeId' is set
            if (documentTypeId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeId' when calling DocumentTypesApi->DocumentTypesGet");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling DocumentTypesApi->DocumentTypesGet");

            var localVarPath = "/document-types/{documentTypeId}";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;TagGroupDefinition&gt;</returns>
        public async System.Threading.Tasks.Task<List<TagGroupDefinition>> DocumentTypesGetAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<TagGroupDefinition>> localVarResponse = await DocumentTypesGetWithHttpInfoAsync(documentTypeId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;TagGroupDefinition&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<TagGroupDefinition>>> DocumentTypesGetWithHttpInfoAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'documentTypeId' is set
            if (documentTypeId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeId' when calling DocumentTypesApi->DocumentTypesGet");
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>List&lt;TagGroupDefinition&gt;</returns>
        public List<TagGroupDefinition> DocumentTypesGetTagGroupDefinitions (Guid documentTypeId, string authorization)
        {
             ApiResponse<List<TagGroupDefinition>> localVarResponse = DocumentTypesGetTagGroupDefinitionsWithHttpInfo(documentTypeId, authorization);
             return localVarResponse.Data;
        }
        ...
        /// <param name="authorization">Bearer JSON Web Token</param>
        /// <returns>ApiResponse of List&lt;TagGroupDefinition&gt;</returns>
        public ApiResponse<List<TagGroupDefinition>> DocumentTypesGetTagGroupDefinitionsWithHttpInfo (Guid documentTypeId, string authorization)
        {
            // verify the required parameter 'documentTypeId' is set
            if (documentTypeId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeId' when calling DocumentTypesApi->DocumentTypesGetTagGroupDefinitions");
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling DocumentTypesApi->DocumentTypesGetTagGroupDefinitions");

            var localVarPath = "/document-types/{documentTypeId}/tag-group-definitions";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DocumentTypesGetTagGroupDefinitions", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;TagGroupDefinition&gt;</returns>
        public async System.Threading.Tasks.Task<List<TagGroupDefinition>> DocumentTypesGetTagGroupDefinitionsAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<TagGroupDefinition>> localVarResponse = await DocumentTypesGetTagGroupDefinitionsWithHttpInfoAsync(documentTypeId, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;TagGroupDefinition&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<TagGroupDefinition>>> DocumentTypesGetTagGroupDefinitionsWithHttpInfoAsync (Guid documentTypeId, string authorization, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'documentTypeId' is set
            if (documentTypeId == null)
                throw new ApiException(400, "Missing required parameter 'documentTypeId' when calling DocumentTypesApi->DocumentTypesGetTagGroupDefinitions");
