...
namespace AmagnoWebApi.Client.Api
{
    ...
    public interface ITokenApi : IApiAccessor
    {
        ...
        /// <param name="loginRequest">Model with Username and Password of the user</param>
        ...
        ApiResponse<string> TokenCreateWithHttpInfo (LoginRequest loginRequest);
        ...
        System.Threading.Tasks.Task<string> TokenCreateAsync (LoginRequest loginRequest, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> TokenCreateWithHttpInfoAsync (LoginRequest loginRequest, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class TokenApi : ITokenApi
    {
        ...
        /// <returns></returns>
        public TokenApi(AmagnoWebApi.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="loginRequest">Model with Username and Password of the user</param>
        /// <returns>string</returns>
        public string TokenCreate (LoginRequest loginRequest)
        {
             ApiResponse<string> localVarResponse = TokenCreateWithHttpInfo(loginRequest);
        ...
        /// <param name="loginRequest">Model with Username and Password of the user</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse<string> TokenCreateWithHttpInfo (LoginRequest loginRequest)
        {
            // verify the required parameter 'loginRequest' is set
            if (loginRequest == null)
                throw new ApiException(400, "Missing required parameter 'loginRequest' when calling TokenApi->TokenCreate");
            ...
            {
                Exception exception = ExceptionFactory("TokenCreate", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> TokenCreateAsync (LoginRequest loginRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<string> localVarResponse = await TokenCreateWithHttpInfoAsync(loginRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> TokenCreateWithHttpInfoAsync (LoginRequest loginRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'loginRequest' is set
            if (loginRequest == null)
                throw new ApiException(400, "Missing required parameter 'loginRequest' when calling TokenApi->TokenCreate");
