...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NumberTagValue :  IEquatable<NumberTagValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberTagValue" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        public NumberTagValue(Guid id = default(Guid), long value = default(long))
        {
            this.Id = id;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberTagValue {\n");
        ...
        {
            return this.Equals(input as NumberTagValue);
        }

        /// <summary>
        /// Returns true if NumberTagValue instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberTagValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberTagValue input)
        {
            if (input == null)
                return false;
