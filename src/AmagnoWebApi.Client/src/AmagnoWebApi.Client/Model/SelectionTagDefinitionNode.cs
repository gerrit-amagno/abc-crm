...
{
    /// <summary>
    /// SelectionTagDefinitionNode
    /// </summary>
    [DataContract]
    public partial class SelectionTagDefinitionNode :  IEquatable<SelectionTagDefinitionNode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionNode" /> class.
        /// </summary>
        ...
        public SelectionTagDefinitionNode(int nodeCount = default(int), Guid id = default(Guid), string value = default(string), bool active = default(bool), Guid parentId = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagDefinitionNode {\n");
        ...
        {
            return this.Equals(input as SelectionTagDefinitionNode);
        }

        /// <summary>
        /// Returns true if SelectionTagDefinitionNode instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagDefinitionNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagDefinitionNode input)
        {
            if (input == null)
                return false;
