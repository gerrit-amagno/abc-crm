...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NumberTag :  IEquatable<NumberTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberTag" /> class.
        /// </summary>
        ...
        public NumberTag(long value = default(long), Guid id = default(Guid), Guid tagDefinitionId = default(Guid), Guid tagGroupDefinitionId = default(Guid), Guid tagGroupId = default(Guid), int insertOrder = default(int))
        {
            this.Value = value;
            this.Id = id;
        ...
        {
            return this.Equals(input as NumberTag);
        }

        /// <summary>
        /// Returns true if NumberTag instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberTag input)
        {
            if (input == null)
                return false;
