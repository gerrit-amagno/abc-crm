...
{
    /// <summary>
    /// SelectionTagDefinitionNodeCreationData
    /// </summary>
    [DataContract]
    public partial class SelectionTagDefinitionNodeCreationData :  IEquatable<SelectionTagDefinitionNodeCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionNodeCreationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SelectionTagDefinitionNodeCreationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionNodeCreationData" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        public SelectionTagDefinitionNodeCreationData(string value = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for SelectionTagDefinitionNodeCreationData and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagDefinitionNodeCreationData {\n");
        ...
        {
            return this.Equals(input as SelectionTagDefinitionNodeCreationData);
        }

        /// <summary>
        /// Returns true if SelectionTagDefinitionNodeCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagDefinitionNodeCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagDefinitionNodeCreationData input)
        {
            if (input == null)
                return false;
