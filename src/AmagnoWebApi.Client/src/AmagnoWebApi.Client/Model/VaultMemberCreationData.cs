...
{
    /// <summary>
    /// VaultMemberCreationData
    /// </summary>
    [DataContract]
    public partial class VaultMemberCreationData :  IEquatable<VaultMemberCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultMemberCreationData" /> class.
        /// </summary>
        /// <param name="userId">Guid of the user.</param>
        public VaultMemberCreationData(Guid userId = default(Guid))
        {
            this.UserId = userId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VaultMemberCreationData {\n");
        ...
        {
            return this.Equals(input as VaultMemberCreationData);
        }

        /// <summary>
        /// Returns true if VaultMemberCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultMemberCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultMemberCreationData input)
        {
            if (input == null)
                return false;
