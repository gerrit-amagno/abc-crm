...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserUpdateData :  IEquatable<UserUpdateData>, IValidatableObject
    {
        /// <summary>
        ...
        public UserUpdateData(string userSid = default(string), bool isInactive = default(bool))
        {
        ...
        {
            return this.Equals(input as UserUpdateData);
        }

        /// <summary>
        /// Returns true if UserUpdateData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserUpdateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserUpdateData input)
        {
            if (input == null)
                return false;
