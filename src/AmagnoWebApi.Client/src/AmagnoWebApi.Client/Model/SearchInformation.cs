...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchInformation :  IEquatable<SearchInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchInformation" /> class.
        /// </summary>
        /// <param name="searchId">GUID of search results.</param>
        /// <param name="totalCount">Total found count.</param>
        public SearchInformation(Guid searchId = default(Guid), int totalCount = default(int))
        {
        ...
        /// </summary>
        /// <value>GUID of search results</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchInformation {\n");
        ...
        {
            return this.Equals(input as SearchInformation);
        }

        /// <summary>
        /// Returns true if SearchInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchInformation input)
        {
            if (input == null)
                return false;
