...
{
    /// <summary>
    /// UserGroupMemberCreationData
    /// </summary>
    [DataContract]
    public partial class UserGroupMemberCreationData :  IEquatable<UserGroupMemberCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupMemberCreationData" /> class.
        /// </summary>
        /// <param name="userId">GUID of the user.</param>
        public UserGroupMemberCreationData(Guid userId = default(Guid))
        {
            this.UserId = userId;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGroupMemberCreationData {\n");
        ...
        {
            return this.Equals(input as UserGroupMemberCreationData);
        }

        /// <summary>
        /// Returns true if UserGroupMemberCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupMemberCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupMemberCreationData input)
        {
            if (input == null)
                return false;
