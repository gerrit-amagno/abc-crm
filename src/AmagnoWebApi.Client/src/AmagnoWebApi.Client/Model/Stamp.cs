...
namespace AmagnoWebApi.Client.Model
{
    ...
    public partial class Stamp :  IEquatable<Stamp>, IValidatableObject
    {
        ...
        public Stamp(Guid id = default(Guid), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as Stamp);
        }

        /// <summary>
        /// Returns true if Stamp instances are equal
        /// </summary>
        /// <param name="input">Instance of Stamp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Stamp input)
        {
            if (input == null)
                return false;
