...
namespace AmagnoWebApi.Client.Model
{
    ...
    public partial class DocumentType :  IEquatable<DocumentType>, IValidatableObject
    {
        ...
        /// <param name="documentTypeCategoryId">documentTypeCategoryId.</param>
        /// <param name="name">name.</param>
        public DocumentType(Guid id = default(Guid), Guid documentTypeCategoryId = default(Guid), string name = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name="documentTypeCategoryId", EmitDefaultValue=false)]
