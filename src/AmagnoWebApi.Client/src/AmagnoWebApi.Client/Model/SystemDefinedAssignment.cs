...
{
    /// <summary>
    /// SystemDefinedAssignment
    /// </summary>
    [DataContract]
    public partial class SystemDefinedAssignment :  IEquatable<SystemDefinedAssignment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemDefinedAssignment" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="parentDocId">parentDocId.</param>
        /// <param name="childDocId">childDocId.</param>
        /// <param name="type">type.</param>
        public SystemDefinedAssignment(Guid id = default(Guid), Guid parentDocId = default(Guid), Guid childDocId = default(Guid), string type = default(string))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ParentDocId
        /// </summary>
        [DataMember(Name="parentDocId", EmitDefaultValue=false)]
        public Guid ParentDocId { get; set; }

        /// <summary>
        /// Gets or Sets ChildDocId
        /// </summary>
        [DataMember(Name="childDocId", EmitDefaultValue=false)]
        public Guid ChildDocId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemDefinedAssignment {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  ParentDocId: ").Append(ParentDocId).Append("\n");
            sb.Append("  ChildDocId: ").Append(ChildDocId).Append("\n");
        ...
        {
            return this.Equals(input as SystemDefinedAssignment);
        }

        /// <summary>
        /// Returns true if SystemDefinedAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemDefinedAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemDefinedAssignment input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ParentDocId == input.ParentDocId ||
                    (this.ParentDocId != null &&
                    this.ParentDocId.Equals(input.ParentDocId))
                ) && 
                (
                    this.ChildDocId == input.ChildDocId ||
                    (this.ChildDocId != null &&
                    this.ChildDocId.Equals(input.ChildDocId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentDocId != null)
                    hashCode = hashCode * 59 + this.ParentDocId.GetHashCode();
                if (this.ChildDocId != null)
                    hashCode = hashCode * 59 + this.ChildDocId.GetHashCode();
                if (this.Type != null)
