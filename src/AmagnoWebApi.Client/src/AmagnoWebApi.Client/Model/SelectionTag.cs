...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SelectionTag :  IEquatable<SelectionTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTag" /> class.
        /// </summary>
        /// <param name="selectedNodeIds">selectedNodeIds.</param>
        ...
        public SelectionTag(List<Guid> selectedNodeIds = default(List<Guid>), Guid id = default(Guid), Guid tagDefinitionId = default(Guid), Guid tagGroupDefinitionId = default(Guid), Guid tagGroupId = default(Guid), int insertOrder = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets SelectedNodeIds
        /// </summary>
        [DataMember(Name="selectedNodeIds", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTag {\n");
            sb.Append("  SelectedNodeIds: ").Append(SelectedNodeIds).Append("\n");
        ...
        {
            return this.Equals(input as SelectionTag);
        }

        /// <summary>
        /// Returns true if SelectionTag instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTag input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.SelectedNodeIds == input.SelectedNodeIds ||
                    this.SelectedNodeIds != null &&
                    input.SelectedNodeIds != null &&
                    this.SelectedNodeIds.SequenceEqual(input.SelectedNodeIds)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SelectedNodeIds != null)
                    hashCode = hashCode * 59 + this.SelectedNodeIds.GetHashCode();
                if (this.Id != null)
