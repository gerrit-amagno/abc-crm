...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MagnetCreationData :  IEquatable<MagnetCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MagnetCreationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MagnetCreationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MagnetCreationData" /> class.
        /// </summary>
        /// <param name="name">Name of the new magnet. (required).</param>
        public MagnetCreationData(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for MagnetCreationData and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// <summary>
        /// Name of the new magnet.
        /// </summary>
        /// <value>Name of the new magnet.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MagnetCreationData {\n");
        ...
        {
            return this.Equals(input as MagnetCreationData);
        }

        /// <summary>
        /// Returns true if MagnetCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of MagnetCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MagnetCreationData input)
        {
            if (input == null)
                return false;
