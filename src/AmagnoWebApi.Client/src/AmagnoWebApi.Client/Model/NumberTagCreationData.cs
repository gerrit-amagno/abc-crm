...
{
    /// <summary>
    /// NumberTagCreationData
    /// </summary>
    [DataContract]
    public partial class NumberTagCreationData :  IEquatable<NumberTagCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberTagCreationData" /> class.
        /// </summary>
        /// <param name="tagDefinitionId">tagDefinitionId.</param>
        /// <param name="value">value.</param>
        public NumberTagCreationData(Guid tagDefinitionId = default(Guid), long value = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberTagCreationData {\n");
        ...
        {
            return this.Equals(input as NumberTagCreationData);
        }

        /// <summary>
        /// Returns true if NumberTagCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberTagCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberTagCreationData input)
        {
            if (input == null)
                return false;
