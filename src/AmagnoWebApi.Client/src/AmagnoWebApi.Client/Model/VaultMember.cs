...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VaultMember :  IEquatable<VaultMember>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultMember" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="vaultId">vaultId.</param>
        /// <param name="userId">userId.</param>
        public VaultMember(Guid id = default(Guid), Guid vaultId = default(Guid), Guid userId = default(Guid))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as VaultMember);
        }

        /// <summary>
        /// Returns true if VaultMember instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultMember to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultMember input)
        {
            if (input == null)
                return false;
