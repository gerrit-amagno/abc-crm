...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Magnet :  IEquatable<Magnet>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="parentMagnetId">parentMagnetId.</param>
        /// <param name="hasCondition">hasCondition.</param>
        public Magnet(Guid id = default(Guid), string name = default(string), Guid parentMagnetId = default(Guid), bool hasCondition = default(bool))
        {
            this.Id = id;
            this.Name = name;
            this.ParentMagnetId = parentMagnetId;
        ...
        /// <summary>
        /// Gets or Sets ParentMagnetId
        /// </summary>
        [DataMember(Name="parentMagnetId", EmitDefaultValue=false)]
        public Guid ParentMagnetId { get; set; }

        /// <summary>
        /// Gets or Sets HasCondition
        /// </summary>
        [DataMember(Name="hasCondition", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Magnet {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  ParentMagnetId: ").Append(ParentMagnetId).Append("\n");
            sb.Append("  HasCondition: ").Append(HasCondition).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Magnet);
        }

        /// <summary>
        /// Returns true if Magnet instances are equal
        /// </summary>
        /// <param name="input">Instance of Magnet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Magnet input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ParentMagnetId == input.ParentMagnetId ||
                    (this.ParentMagnetId != null &&
                    this.ParentMagnetId.Equals(input.ParentMagnetId))
                ) && 
                (
                    this.HasCondition == input.HasCondition ||
                    (this.HasCondition != null &&
                    this.HasCondition.Equals(input.HasCondition))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentMagnetId != null)
                    hashCode = hashCode * 59 + this.ParentMagnetId.GetHashCode();
                if (this.HasCondition != null)
                    hashCode = hashCode * 59 + this.HasCondition.GetHashCode();
                return hashCode;
            }
        }
