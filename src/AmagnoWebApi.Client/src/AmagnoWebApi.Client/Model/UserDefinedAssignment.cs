...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserDefinedAssignment :  IEquatable<UserDefinedAssignment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserDefinedAssignment" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="parentDocId">parentDocId.</param>
        /// <param name="childDocId">childDocId.</param>
        /// <param name="type">type.</param>
        public UserDefinedAssignment(Guid id = default(Guid), Guid parentDocId = default(Guid), Guid childDocId = default(Guid), string type = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserDefinedAssignment {\n");
        ...
        {
            return this.Equals(input as UserDefinedAssignment);
        }

        /// <summary>
        /// Returns true if UserDefinedAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of UserDefinedAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserDefinedAssignment input)
        {
            if (input == null)
                return false;
