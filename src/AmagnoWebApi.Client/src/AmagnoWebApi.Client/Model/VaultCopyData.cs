...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VaultCopyData :  IEquatable<VaultCopyData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultCopyData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VaultCopyData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultCopyData" /> class.
        /// </summary>
        /// <param name="name">Name of the new vault. (required).</param>
        /// <param name="copyDocuments">Specifies whether contained documents are copied or not..</param>
        /// <param name="copyMembers">Specifies whether contained members are copied or not..</param>
        /// <param name="recreateWeblinks">Specifies whether contained WebLinks are recreated or not..</param>
        /// <param name="copyEmailSettings">Specifies whether contained email settings are copied or not..</param>
        public VaultCopyData(string name = default(string), bool copyDocuments = default(bool), bool copyMembers = default(bool), bool recreateWeblinks = default(bool), bool copyEmailSettings = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for VaultCopyData and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            this.RecreateWeblinks = recreateWeblinks;
            this.CopyEmailSettings = copyEmailSettings;
        }
        
        /// <summary>
        /// Name of the new vault.
        /// </summary>
        /// <value>Name of the new vault.</value>
        [DataMember(Name="name", EmitDefaultValue=true)]
        public string Name { get; set; }

        /// <summary>
        /// Specifies whether contained documents are copied or not.
        /// </summary>
        /// <value>Specifies whether contained documents are copied or not.</value>
        [DataMember(Name="copyDocuments", EmitDefaultValue=false)]
        public bool CopyDocuments { get; set; }

        /// <summary>
        /// Specifies whether contained members are copied or not.
        /// </summary>
        /// <value>Specifies whether contained members are copied or not.</value>
        [DataMember(Name="copyMembers", EmitDefaultValue=false)]
        public bool CopyMembers { get; set; }

        /// <summary>
        /// Specifies whether contained WebLinks are recreated or not.
        /// </summary>
        /// <value>Specifies whether contained WebLinks are recreated or not.</value>
        [DataMember(Name="recreateWeblinks", EmitDefaultValue=false)]
        public bool RecreateWeblinks { get; set; }

        /// <summary>
        /// Specifies whether contained email settings are copied or not.
        /// </summary>
        /// <value>Specifies whether contained email settings are copied or not.</value>
        [DataMember(Name="copyEmailSettings", EmitDefaultValue=false)]
        public bool CopyEmailSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VaultCopyData {\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  CopyDocuments: ").Append(CopyDocuments).Append("\n");
            sb.Append("  CopyMembers: ").Append(CopyMembers).Append("\n");
            sb.Append("  RecreateWeblinks: ").Append(RecreateWeblinks).Append("\n");
            sb.Append("  CopyEmailSettings: ").Append(CopyEmailSettings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as VaultCopyData);
        }

        /// <summary>
        /// Returns true if VaultCopyData instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultCopyData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultCopyData input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CopyDocuments == input.CopyDocuments ||
                    (this.CopyDocuments != null &&
                    this.CopyDocuments.Equals(input.CopyDocuments))
                ) && 
                (
                    this.CopyMembers == input.CopyMembers ||
                    (this.CopyMembers != null &&
                    this.CopyMembers.Equals(input.CopyMembers))
                ) && 
                (
                    this.RecreateWeblinks == input.RecreateWeblinks ||
                    (this.RecreateWeblinks != null &&
                    this.RecreateWeblinks.Equals(input.RecreateWeblinks))
                ) && 
                (
                    this.CopyEmailSettings == input.CopyEmailSettings ||
                    (this.CopyEmailSettings != null &&
                    this.CopyEmailSettings.Equals(input.CopyEmailSettings))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CopyDocuments != null)
                    hashCode = hashCode * 59 + this.CopyDocuments.GetHashCode();
                if (this.CopyMembers != null)
                    hashCode = hashCode * 59 + this.CopyMembers.GetHashCode();
                if (this.RecreateWeblinks != null)
                    hashCode = hashCode * 59 + this.RecreateWeblinks.GetHashCode();
                if (this.CopyEmailSettings != null)
                    hashCode = hashCode * 59 + this.CopyEmailSettings.GetHashCode();
                return hashCode;
            }
        }
