...
{
    /// <summary>
    /// MultiLineStringTagDefinition
    /// </summary>
    [DataContract]
    public partial class MultiLineStringTagDefinition :  IEquatable<MultiLineStringTagDefinition>, IValidatableObject
    {
        /// <summary>
        /// Defines SourceType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiLineStringTagDefinition" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultiLineStringTagDefinition {\n");
        ...
        {
            return this.Equals(input as MultiLineStringTagDefinition);
        }

        /// <summary>
        /// Returns true if MultiLineStringTagDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiLineStringTagDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiLineStringTagDefinition input)
        {
            if (input == null)
                return false;
