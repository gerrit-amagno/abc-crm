...
{
    /// <summary>
    /// SelectionTagDefinitionTreeNode
    /// </summary>
    [DataContract]
    public partial class SelectionTagDefinitionTreeNode :  IEquatable<SelectionTagDefinitionTreeNode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionTreeNode" /> class.
        /// </summary>
        ...
        public SelectionTagDefinitionTreeNode(List<SelectionTagDefinitionTreeNode> nodes = default(List<SelectionTagDefinitionTreeNode>), Guid id = default(Guid), string value = default(string), bool active = default(bool), Guid parentId = default(Guid))
        {
            this.Nodes = nodes;
            this.Id = id;
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagDefinitionTreeNode {\n");
        ...
        {
            return this.Equals(input as SelectionTagDefinitionTreeNode);
        }

        /// <summary>
        /// Returns true if SelectionTagDefinitionTreeNode instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagDefinitionTreeNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagDefinitionTreeNode input)
        {
            if (input == null)
                return false;
