...
{
    /// <summary>
    /// SingleLineStringTagCreationData
    /// </summary>
    [DataContract]
    public partial class SingleLineStringTagCreationData :  IEquatable<SingleLineStringTagCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleLineStringTagCreationData" /> class.
        /// </summary>
        /// <param name="tagDefinitionId">tagDefinitionId.</param>
        /// <param name="value">value.</param>
        public SingleLineStringTagCreationData(Guid tagDefinitionId = default(Guid), string value = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleLineStringTagCreationData {\n");
        ...
        {
            return this.Equals(input as SingleLineStringTagCreationData);
        }

        /// <summary>
        /// Returns true if SingleLineStringTagCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleLineStringTagCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleLineStringTagCreationData input)
        {
            if (input == null)
                return false;
