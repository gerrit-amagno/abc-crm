...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StampAnnotation :  IEquatable<StampAnnotation>, IValidatableObject
    {
        /// <summary>
        ...
        public StampAnnotation(byte[] image = default(byte[]), double height = default(double), double width = default(double), Guid id = default(Guid), int pageNo = default(int), double startX = default(double), double startY = default(double), int zOrder = default(int))
        {
            this.Image = image;
            this.Height = height;
            this.Width = width;
        ...
        {
            return this.Equals(input as StampAnnotation);
        }

        /// <summary>
        /// Returns true if StampAnnotation instances are equal
        /// </summary>
        /// <param name="input">Instance of StampAnnotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StampAnnotation input)
        {
            if (input == null)
                return false;
