...
{
    /// <summary>
    /// SingleLineStringTagValue
    /// </summary>
    [DataContract]
    public partial class SingleLineStringTagValue :  IEquatable<SingleLineStringTagValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleLineStringTagValue" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        public SingleLineStringTagValue(Guid id = default(Guid), string value = default(string))
        {
            this.Id = id;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleLineStringTagValue {\n");
        ...
        {
            return this.Equals(input as SingleLineStringTagValue);
        }

        /// <summary>
        /// Returns true if SingleLineStringTagValue instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleLineStringTagValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleLineStringTagValue input)
        {
            if (input == null)
                return false;
