...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssignmentCreationData :  IEquatable<AssignmentCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentCreationData" /> class.
        /// </summary>
        /// <param name="parentDocId">parentDocId.</param>
        /// <param name="childDocId">childDocId.</param>
        public AssignmentCreationData(Guid parentDocId = default(Guid), Guid childDocId = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssignmentCreationData {\n");
        ...
        {
            return this.Equals(input as AssignmentCreationData);
        }

        /// <summary>
        /// Returns true if AssignmentCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of AssignmentCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignmentCreationData input)
        {
            if (input == null)
                return false;
