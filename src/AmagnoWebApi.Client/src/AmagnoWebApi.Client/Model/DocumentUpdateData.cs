...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentUpdateData :  IEquatable<DocumentUpdateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentUpdateData" /> class.
        /// </summary>
        /// <param name="name">Name of the document.</param>
        public DocumentUpdateData(string name = default(string))
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentUpdateData {\n");
        ...
        {
            return this.Equals(input as DocumentUpdateData);
        }

        /// <summary>
        /// Returns true if DocumentUpdateData instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentUpdateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentUpdateData input)
        {
            if (input == null)
                return false;
