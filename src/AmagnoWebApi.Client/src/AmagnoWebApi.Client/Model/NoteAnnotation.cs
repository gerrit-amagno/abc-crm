...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NoteAnnotation :  IEquatable<NoteAnnotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteAnnotation" /> class.
        /// </summary>
        ...
        public NoteAnnotation(string backColor = default(string), string foreColor = default(string), string text = default(string), double height = default(double), double width = default(double), Guid id = default(Guid), int pageNo = default(int), double startX = default(double), double startY = default(double), int zOrder = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NoteAnnotation {\n");
        ...
        {
            return this.Equals(input as NoteAnnotation);
        }

        /// <summary>
        /// Returns true if NoteAnnotation instances are equal
        /// </summary>
        /// <param name="input">Instance of NoteAnnotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NoteAnnotation input)
        {
            if (input == null)
                return false;
