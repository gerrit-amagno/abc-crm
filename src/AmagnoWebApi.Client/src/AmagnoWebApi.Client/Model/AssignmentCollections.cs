...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssignmentCollections :  IEquatable<AssignmentCollections>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentCollections" /> class.
        /// </summary>
        /// <param name="mergeDefinedAssignments">mergeDefinedAssignments.</param>
        /// <param name="userDefinedAssignments">userDefinedAssignments.</param>
        /// <param name="systemDefinedAssignments">systemDefinedAssignments.</param>
        public AssignmentCollections(List<MergeDefinedAssignment> mergeDefinedAssignments = default(List<MergeDefinedAssignment>), List<UserDefinedAssignment> userDefinedAssignments = default(List<UserDefinedAssignment>), List<SystemDefinedAssignment> systemDefinedAssignments = default(List<SystemDefinedAssignment>))
        {
            this.MergeDefinedAssignments = mergeDefinedAssignments;
            this.UserDefinedAssignments = userDefinedAssignments;
            this.SystemDefinedAssignments = systemDefinedAssignments;
        }
        
        /// <summary>
        /// Gets or Sets MergeDefinedAssignments
        /// </summary>
        [DataMember(Name="mergeDefinedAssignments", EmitDefaultValue=false)]
        public List<MergeDefinedAssignment> MergeDefinedAssignments { get; set; }

        /// <summary>
        /// Gets or Sets UserDefinedAssignments
        /// </summary>
        [DataMember(Name="userDefinedAssignments", EmitDefaultValue=false)]
        public List<UserDefinedAssignment> UserDefinedAssignments { get; set; }

        /// <summary>
        /// Gets or Sets SystemDefinedAssignments
        /// </summary>
        [DataMember(Name="systemDefinedAssignments", EmitDefaultValue=false)]
        public List<SystemDefinedAssignment> SystemDefinedAssignments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssignmentCollections {\n");
            sb.Append("  MergeDefinedAssignments: ").Append(MergeDefinedAssignments).Append("\n");
            sb.Append("  UserDefinedAssignments: ").Append(UserDefinedAssignments).Append("\n");
            sb.Append("  SystemDefinedAssignments: ").Append(SystemDefinedAssignments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AssignmentCollections);
        }

        /// <summary>
        /// Returns true if AssignmentCollections instances are equal
        /// </summary>
        /// <param name="input">Instance of AssignmentCollections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignmentCollections input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MergeDefinedAssignments == input.MergeDefinedAssignments ||
                    this.MergeDefinedAssignments != null &&
                    input.MergeDefinedAssignments != null &&
                    this.MergeDefinedAssignments.SequenceEqual(input.MergeDefinedAssignments)
                ) && 
                (
                    this.UserDefinedAssignments == input.UserDefinedAssignments ||
                    this.UserDefinedAssignments != null &&
                    input.UserDefinedAssignments != null &&
                    this.UserDefinedAssignments.SequenceEqual(input.UserDefinedAssignments)
                ) && 
                (
                    this.SystemDefinedAssignments == input.SystemDefinedAssignments ||
                    this.SystemDefinedAssignments != null &&
                    input.SystemDefinedAssignments != null &&
                    this.SystemDefinedAssignments.SequenceEqual(input.SystemDefinedAssignments)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MergeDefinedAssignments != null)
                    hashCode = hashCode * 59 + this.MergeDefinedAssignments.GetHashCode();
                if (this.UserDefinedAssignments != null)
                    hashCode = hashCode * 59 + this.UserDefinedAssignments.GetHashCode();
                if (this.SystemDefinedAssignments != null)
                    hashCode = hashCode * 59 + this.SystemDefinedAssignments.GetHashCode();
                return hashCode;
            }
        }
