...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StampingData :  IEquatable<StampingData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StampingData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StampingData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StampingData" /> class.
        /// </summary>
        /// <param name="stampId">The stamp&#39;s id (required).</param>
        public StampingData(Guid stampId = default(Guid))
        {
            // to ensure "stampId" is required (not null)
            if (stampId == null)
            {
                throw new InvalidDataException("stampId is a required property for StampingData and cannot be null");
            }
            else
            {
        ...
        /// The stamp&#39;s id
        /// </summary>
        /// <value>The stamp&#39;s id</value>
        [DataMember(Name="stampId", EmitDefaultValue=true)]
        ...
        {
            return this.Equals(input as StampingData);
        }

        /// <summary>
        /// Returns true if StampingData instances are equal
        /// </summary>
        /// <param name="input">Instance of StampingData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StampingData input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.StampId == input.StampId ||
                    (this.StampId != null &&
                    this.StampId.Equals(input.StampId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StampId != null)
                    hashCode = hashCode * 59 + this.StampId.GetHashCode();
                return hashCode;
            }
        }
