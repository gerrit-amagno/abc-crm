...
{
    /// <summary>
    /// CounterTagDefinition
    /// </summary>
    [DataContract]
    public partial class CounterTagDefinition :  IEquatable<CounterTagDefinition>, IValidatableObject
    {
        /// <summary>
        /// Defines SourceType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CounterTagDefinition" /> class.
        /// </summary>
        ...
        public CounterTagDefinition(int decimalPlaces = default(int), long defaultValue = default(long), Guid id = default(Guid), Guid vaultId = default(Guid), Guid tagGroupDefinitionId = default(Guid), string caption = default(string), SourceTypeEnum? sourceType = default(SourceTypeEnum?), bool sortable = default(bool), bool singleTag = default(bool), AddRuleEnum? addRule = default(AddRuleEnum?), OverwriteRuleEnum? overwriteRule = default(OverwriteRuleEnum?), bool editProtection = default(bool), bool userInput = default(bool), bool inputRequired = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CounterTagDefinition {\n");
        ...
        {
            return this.Equals(input as CounterTagDefinition);
        }

        /// <summary>
        /// Returns true if CounterTagDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CounterTagDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CounterTagDefinition input)
        {
            if (input == null)
                return false;
