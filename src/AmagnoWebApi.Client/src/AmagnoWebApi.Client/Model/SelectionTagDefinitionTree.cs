...
{
    /// <summary>
    /// SelectionTagDefinitionTree
    /// </summary>
    [DataContract]
    public partial class SelectionTagDefinitionTree :  IEquatable<SelectionTagDefinitionTree>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionTree" /> class.
        /// </summary>
        /// <param name="nodes">nodes.</param>
        public SelectionTagDefinitionTree(List<SelectionTagDefinitionTreeNode> nodes = default(List<SelectionTagDefinitionTreeNode>))
        {
            this.Nodes = nodes;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagDefinitionTree {\n");
        ...
        {
            return this.Equals(input as SelectionTagDefinitionTree);
        }

        /// <summary>
        /// Returns true if SelectionTagDefinitionTree instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagDefinitionTree to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagDefinitionTree input)
        {
            if (input == null)
                return false;
