...
{
    /// <summary>
    /// SelectionTagDefinitionNodeUpdateData
    /// </summary>
    [DataContract]
    public partial class SelectionTagDefinitionNodeUpdateData :  IEquatable<SelectionTagDefinitionNodeUpdateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionNodeUpdateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SelectionTagDefinitionNodeUpdateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagDefinitionNodeUpdateData" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="active">active (required).</param>
        /// <param name="parentId">If parentId has changed, the current node will be set as the last new parent node.</param>
        public SelectionTagDefinitionNodeUpdateData(string value = default(string), bool active = default(bool), Guid parentId = default(Guid))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for SelectionTagDefinitionNodeUpdateData and cannot be null");
            }
            else
            {
                this.Value = value;
            ...
            if (active == null)
            {
                throw new InvalidDataException("active is a required property for SelectionTagDefinitionNodeUpdateData and cannot be null");
            }
            else
            {
                this.Active = active;
        ...
        /// <summary>
        /// If parentId has changed, the current node will be set as the last new parent node
        /// </summary>
        /// <value>If parentId has changed, the current node will be set as the last new parent node</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagDefinitionNodeUpdateData {\n");
        ...
        {
            return this.Equals(input as SelectionTagDefinitionNodeUpdateData);
        }

        /// <summary>
        /// Returns true if SelectionTagDefinitionNodeUpdateData instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagDefinitionNodeUpdateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagDefinitionNodeUpdateData input)
        {
            if (input == null)
                return false;
