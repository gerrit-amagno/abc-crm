...
{
    /// <summary>
    /// AdvancedDocumentSearchFilter
    /// </summary>
    [DataContract]
    public partial class AdvancedDocumentSearchFilter :  IEquatable<AdvancedDocumentSearchFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedDocumentSearchFilter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancedDocumentSearchFilter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedDocumentSearchFilter" /> class.
        /// </summary>
        ...
        public AdvancedDocumentSearchFilter(Condition condition = default(Condition), List<Guid> vaultIds = default(List<Guid>), SortInformation sortInformation = default(SortInformation))
        {
            // to ensure "condition" is required (not null)
            if (condition == null)
            {
                throw new InvalidDataException("condition is a required property for AdvancedDocumentSearchFilter and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedDocumentSearchFilter {\n");
        ...
        {
            return this.Equals(input as AdvancedDocumentSearchFilter);
        }

        /// <summary>
        /// Returns true if AdvancedDocumentSearchFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedDocumentSearchFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedDocumentSearchFilter input)
        {
            if (input == null)
                return false;
