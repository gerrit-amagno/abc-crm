...
{
    /// <summary>
    /// InkAnnotationCreationData
    /// </summary>
    [DataContract]
    public partial class InkAnnotationCreationData :  IEquatable<InkAnnotationCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InkAnnotationCreationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InkAnnotationCreationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InkAnnotationCreationData" /> class.
        /// </summary>
        ...
        public InkAnnotationCreationData(byte[] image = default(byte[]), double height = default(double), double width = default(double), int pageNo = default(int), double startX = default(double), double startY = default(double))
        {
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new InvalidDataException("image is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Image = image;
            ...
            if (height == null)
            {
                throw new InvalidDataException("height is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Height = height;
            ...
            if (width == null)
            {
                throw new InvalidDataException("width is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Width = width;
            ...
            if (pageNo == null)
            {
                throw new InvalidDataException("pageNo is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.PageNo = pageNo;
            ...
            if (startX == null)
            {
                throw new InvalidDataException("startX is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.StartX = startX;
            ...
            if (startY == null)
            {
                throw new InvalidDataException("startY is a required property for InkAnnotationCreationData and cannot be null");
            }
            else
            {
                this.StartY = startY;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InkAnnotationCreationData {\n");
        ...
        {
            return this.Equals(input as InkAnnotationCreationData);
        }

        /// <summary>
        /// Returns true if InkAnnotationCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of InkAnnotationCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InkAnnotationCreationData input)
        {
            if (input == null)
                return false;
