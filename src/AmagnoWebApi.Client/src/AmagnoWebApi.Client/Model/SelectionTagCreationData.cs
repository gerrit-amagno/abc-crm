...
{
    /// <summary>
    /// SelectionTagCreationData
    /// </summary>
    [DataContract]
    public partial class SelectionTagCreationData :  IEquatable<SelectionTagCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagCreationData" /> class.
        /// </summary>
        /// <param name="tagDefinitionId">tagDefinitionId.</param>
        /// <param name="value">value.</param>
        public SelectionTagCreationData(Guid tagDefinitionId = default(Guid), List<Guid> value = default(List<Guid>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagCreationData {\n");
        ...
        {
            return this.Equals(input as SelectionTagCreationData);
        }

        /// <summary>
        /// Returns true if SelectionTagCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagCreationData input)
        {
            if (input == null)
                return false;
