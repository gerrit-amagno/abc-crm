...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MultiLineStringTag :  IEquatable<MultiLineStringTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiLineStringTag" /> class.
        /// </summary>
        ...
        public MultiLineStringTag(string value = default(string), Guid id = default(Guid), Guid tagDefinitionId = default(Guid), Guid tagGroupDefinitionId = default(Guid), Guid tagGroupId = default(Guid), int insertOrder = default(int))
        {
            this.Value = value;
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultiLineStringTag {\n");
        ...
        {
            return this.Equals(input as MultiLineStringTag);
        }

        /// <summary>
        /// Returns true if MultiLineStringTag instances are equal
        /// </summary>
        /// <param name="input">Instance of MultiLineStringTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MultiLineStringTag input)
        {
            if (input == null)
                return false;
