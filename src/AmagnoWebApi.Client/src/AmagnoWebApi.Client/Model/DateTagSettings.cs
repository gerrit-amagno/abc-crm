...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DateTagSettings :  IEquatable<DateTagSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTagSettings" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="tagReferenceId">tagReferenceId.</param>
        /// <param name="dynamicDateSettings">dynamicDateSettings.</param>
        public DateTagSettings(DateTime value = default(DateTime), Guid tagReferenceId = default(Guid), DynamicDateSettings dynamicDateSettings = default(DynamicDateSettings))
        {
            this.Value = value;
            this.TagReferenceId = tagReferenceId;
            this.DynamicDateSettings = dynamicDateSettings;
        }
        ...
        /// <summary>
        /// Gets or Sets TagReferenceId
        /// </summary>
        [DataMember(Name="tagReferenceId", EmitDefaultValue=false)]
        public Guid TagReferenceId { get; set; }

        /// <summary>
        /// Gets or Sets DynamicDateSettings
        /// </summary>
        [DataMember(Name="dynamicDateSettings", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateTagSettings {\n");
            sb.Append("  Value: ").Append(Value).Append("\n");
            sb.Append("  TagReferenceId: ").Append(TagReferenceId).Append("\n");
            sb.Append("  DynamicDateSettings: ").Append(DynamicDateSettings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DateTagSettings);
        }

        /// <summary>
        /// Returns true if DateTagSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTagSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTagSettings input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TagReferenceId == input.TagReferenceId ||
                    (this.TagReferenceId != null &&
                    this.TagReferenceId.Equals(input.TagReferenceId))
                ) && 
                (
                    this.DynamicDateSettings == input.DynamicDateSettings ||
                    (this.DynamicDateSettings != null &&
                    this.DynamicDateSettings.Equals(input.DynamicDateSettings))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TagReferenceId != null)
                    hashCode = hashCode * 59 + this.TagReferenceId.GetHashCode();
                if (this.DynamicDateSettings != null)
                    hashCode = hashCode * 59 + this.DynamicDateSettings.GetHashCode();
                return hashCode;
            }
        }
