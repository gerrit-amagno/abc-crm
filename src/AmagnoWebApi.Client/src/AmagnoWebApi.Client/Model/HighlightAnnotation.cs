...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HighlightAnnotation :  IEquatable<HighlightAnnotation>, IValidatableObject
    {
        /// <summary>
        ...
        public HighlightAnnotation(string color = default(string), double height = default(double), double width = default(double), Guid id = default(Guid), int pageNo = default(int), double startX = default(double), double startY = default(double), int zOrder = default(int))
        {
            this.Color = color;
            this.Height = height;
            this.Width = width;
        ...
        {
            return this.Equals(input as HighlightAnnotation);
        }

        /// <summary>
        /// Returns true if HighlightAnnotation instances are equal
        /// </summary>
        /// <param name="input">Instance of HighlightAnnotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HighlightAnnotation input)
        {
            if (input == null)
                return false;
