...
namespace AmagnoWebApi.Client.Model
{
    ...
    public partial class FileMetadata :  IEquatable<FileMetadata>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FileMetadata" /> class.
        /// </summary>
        /// <param name="createDate">Create UTC in ISO 8601 format (required).</param>
        /// <param name="changeDate">Last change UTC in ISO 8601 format (required).</param>
        /// <param name="name">Name (required).</param>
        /// <param name="size">Size in bytes (required).</param>
        public FileMetadata(DateTime createDate = default(DateTime), DateTime changeDate = default(DateTime), string name = default(string), long size = default(long))
        {
            // to ensure "createDate" is required (not null)
            if (createDate == null)
            {
                throw new InvalidDataException("createDate is a required property for FileMetadata and cannot be null");
            }
            else
            {
            ...
            // to ensure "changeDate" is required (not null)
            if (changeDate == null)
            {
                throw new InvalidDataException("changeDate is a required property for FileMetadata and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FileMetadata and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (size == null)
            {
                throw new InvalidDataException("size is a required property for FileMetadata and cannot be null");
            }
            else
            {
                this.Size = size;
        ...
        /// <summary>
        /// Create UTC in ISO 8601 format
        /// </summary>
        /// <value>Create UTC in ISO 8601 format</value>
        [DataMember(Name="createDate", EmitDefaultValue=true)]
        public DateTime CreateDate { get; set; }

        /// <summary>
        /// Last change UTC in ISO 8601 format
        /// </summary>
        /// <value>Last change UTC in ISO 8601 format</value>
        [DataMember(Name="changeDate", EmitDefaultValue=true)]
