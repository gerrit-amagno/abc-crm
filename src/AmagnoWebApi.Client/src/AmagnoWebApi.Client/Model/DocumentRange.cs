...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentRange :  IEquatable<DocumentRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentRange" /> class.
        /// </summary>
        /// <param name="count">Count of returned documents (optional - default 50).</param>
        /// <param name="offset">Offset of the first returned documents (optional - default 0).</param>
        public DocumentRange(int count = default(int), int offset = default(int))
        {
            this.Count = count;
            this.Offset = offset;
        }
        ...
        /// </summary>
        /// <value>Count of returned documents (optional - default 50)</value>
        ...
        /// </summary>
        /// <value>Offset of the first returned documents (optional - default 0)</value>
        ...
        {
            return this.Equals(input as DocumentRange);
        }

        /// <summary>
        /// Returns true if DocumentRange instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentRange input)
        {
            if (input == null)
                return false;
