...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TagGroupDefinition :  IEquatable<TagGroupDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagGroupDefinition" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public TagGroupDefinition(Guid id = default(Guid), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagGroupDefinition {\n");
        ...
        {
            return this.Equals(input as TagGroupDefinition);
        }

        /// <summary>
        /// Returns true if TagGroupDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TagGroupDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagGroupDefinition input)
        {
            if (input == null)
                return false;
