...
{
    /// <summary>
    /// TagGroupCreationData
    /// </summary>
    [DataContract]
    public partial class TagGroupCreationData :  IEquatable<TagGroupCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagGroupCreationData" /> class.
        /// </summary>
        /// <param name="tagGroupDefinitionId">GUID of the tag group definition.</param>
        /// <param name="singleLineStrings">Single-line text strings.</param>
        /// <param name="dates">UTCs in ISO 8601 format.</param>
        /// <param name="numbers">Long values, where last X numbers are decimal part.  X is DecimalNumber field from appropriated tag definition.</param>
        /// <param name="selections">Selection values.</param>
        public TagGroupCreationData(Guid tagGroupDefinitionId = default(Guid), List<SingleLineStringTagCreationData> singleLineStrings = default(List<SingleLineStringTagCreationData>), List<DateTagCreationData> dates = default(List<DateTagCreationData>), List<NumberTagCreationData> numbers = default(List<NumberTagCreationData>), List<SelectionTagCreationData> selections = default(List<SelectionTagCreationData>))
        {
        ...
        /// </summary>
        /// <value>GUID of the tag group definition</value>
        [DataMember(Name="tagGroupDefinitionId", EmitDefaultValue=false)]
        public Guid TagGroupDefinitionId { get; set; }

        /// <summary>
        /// Single-line text strings
        /// </summary>
        /// <value>Single-line text strings</value>
        [DataMember(Name="singleLineStrings", EmitDefaultValue=false)]
        public List<SingleLineStringTagCreationData> SingleLineStrings { get; set; }

        /// <summary>
        /// UTCs in ISO 8601 format
        /// </summary>
        /// <value>UTCs in ISO 8601 format</value>
        [DataMember(Name="dates", EmitDefaultValue=false)]
        public List<DateTagCreationData> Dates { get; set; }

        /// <summary>
        /// Long values, where last X numbers are decimal part.  X is DecimalNumber field from appropriated tag definition
        /// </summary>
        /// <value>Long values, where last X numbers are decimal part.  X is DecimalNumber field from appropriated tag definition</value>
        [DataMember(Name="numbers", EmitDefaultValue=false)]
        public List<NumberTagCreationData> Numbers { get; set; }

        /// <summary>
        /// Selection values
        /// </summary>
        /// <value>Selection values</value>
        [DataMember(Name="selections", EmitDefaultValue=false)]
        public List<SelectionTagCreationData> Selections { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagGroupCreationData {\n");
        ...
        {
            return this.Equals(input as TagGroupCreationData);
        }

        /// <summary>
        /// Returns true if TagGroupCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of TagGroupCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagGroupCreationData input)
        {
            if (input == null)
                return false;
