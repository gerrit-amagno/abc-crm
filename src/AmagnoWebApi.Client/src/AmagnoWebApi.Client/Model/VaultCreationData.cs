...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VaultCreationData :  IEquatable<VaultCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultCreationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VaultCreationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VaultCreationData" /> class.
        /// </summary>
        /// <param name="name">Name of the new vault. (required).</param>
        public VaultCreationData(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for VaultCreationData and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VaultCreationData {\n");
        ...
        {
            return this.Equals(input as VaultCreationData);
        }

        /// <summary>
        /// Returns true if VaultCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of VaultCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VaultCreationData input)
        {
            if (input == null)
                return false;
