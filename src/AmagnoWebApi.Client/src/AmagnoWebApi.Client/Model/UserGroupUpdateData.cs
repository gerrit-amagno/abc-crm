...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserGroupUpdateData :  IEquatable<UserGroupUpdateData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupUpdateData" /> class.
        /// </summary>
        /// <param name="name">Name of the user group.</param>
        public UserGroupUpdateData(string name = default(string))
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGroupUpdateData {\n");
        ...
        {
            return this.Equals(input as UserGroupUpdateData);
        }

        /// <summary>
        /// Returns true if UserGroupUpdateData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupUpdateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupUpdateData input)
        {
            if (input == null)
                return false;
