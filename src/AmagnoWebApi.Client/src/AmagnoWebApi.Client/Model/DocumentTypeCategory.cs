...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentTypeCategory :  IEquatable<DocumentTypeCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTypeCategory" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public DocumentTypeCategory(Guid id = default(Guid), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentTypeCategory {\n");
        ...
        {
            return this.Equals(input as DocumentTypeCategory);
        }

        /// <summary>
        /// Returns true if DocumentTypeCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentTypeCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentTypeCategory input)
        {
            if (input == null)
                return false;
