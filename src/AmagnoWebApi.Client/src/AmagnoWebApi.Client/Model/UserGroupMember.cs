...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserGroupMember :  IEquatable<UserGroupMember>, IValidatableObject
    {
        /// <summary>
        ...
        public UserGroupMember(Guid id = default(Guid), Guid userGroupId = default(Guid), Guid userId = default(Guid))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as UserGroupMember);
        }

        /// <summary>
        /// Returns true if UserGroupMember instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupMember to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupMember input)
        {
            if (input == null)
                return false;
