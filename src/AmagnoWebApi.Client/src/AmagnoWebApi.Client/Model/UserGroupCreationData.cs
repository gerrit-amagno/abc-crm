...
{
    /// <summary>
    /// UserGroupCreationData
    /// </summary>
    [DataContract]
    public partial class UserGroupCreationData :  IEquatable<UserGroupCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupCreationData" /> class.
        /// </summary>
        /// <param name="name">Name of the user group.</param>
        public UserGroupCreationData(string name = default(string))
        {
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGroupCreationData {\n");
        ...
        {
            return this.Equals(input as UserGroupCreationData);
        }

        /// <summary>
        /// Returns true if UserGroupCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupCreationData input)
        {
            if (input == null)
                return false;
