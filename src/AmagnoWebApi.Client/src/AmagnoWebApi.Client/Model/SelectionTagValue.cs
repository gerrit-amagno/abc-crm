...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SelectionTagValue :  IEquatable<SelectionTagValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SelectionTagValue" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="value">value.</param>
        public SelectionTagValue(Guid id = default(Guid), List<Guid> value = default(List<Guid>))
        {
            this.Id = id;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SelectionTagValue {\n");
        ...
        {
            return this.Equals(input as SelectionTagValue);
        }

        /// <summary>
        /// Returns true if SelectionTagValue instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectionTagValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectionTagValue input)
        {
            if (input == null)
                return false;
