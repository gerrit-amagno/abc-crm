...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignatureAnnotation :  IEquatable<SignatureAnnotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureAnnotation" /> class.
        /// </summary>
        ...
        public SignatureAnnotation(byte[] image = default(byte[]), double height = default(double), double width = default(double), Guid id = default(Guid), int pageNo = default(int), double startX = default(double), double startY = default(double), int zOrder = default(int))
        {
            this.Image = image;
            this.Height = height;
            this.Width = width;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureAnnotation {\n");
        ...
        {
            return this.Equals(input as SignatureAnnotation);
        }

        /// <summary>
        /// Returns true if SignatureAnnotation instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureAnnotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureAnnotation input)
        {
            if (input == null)
                return false;
