...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarkLineAnnotation :  IEquatable<MarkLineAnnotation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkLineAnnotation" /> class.
        /// </summary>
        ...
        public MarkLineAnnotation(string color = default(string), int lineWidth = default(int), double endX = default(double), double endY = default(double), Guid id = default(Guid), int pageNo = default(int), double startX = default(double), double startY = default(double), int zOrder = default(int))
        {
            this.Color = color;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarkLineAnnotation {\n");
        ...
        {
            return this.Equals(input as MarkLineAnnotation);
        }

        /// <summary>
        /// Returns true if MarkLineAnnotation instances are equal
        /// </summary>
        /// <param name="input">Instance of MarkLineAnnotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarkLineAnnotation input)
        {
            if (input == null)
                return false;
