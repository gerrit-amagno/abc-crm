...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CounterTag :  IEquatable<CounterTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CounterTag" /> class.
        /// </summary>
        /// <param name="value">Long value, where last X numbers are decimal part. X is DecimalNumbers field from appropriated tag definition.</param>
        ...
        public CounterTag(long value = default(long), Guid id = default(Guid), Guid tagDefinitionId = default(Guid), Guid tagGroupDefinitionId = default(Guid), Guid tagGroupId = default(Guid), int insertOrder = default(int))
        {
            this.Value = value;
            this.Id = id;
        ...
        /// <summary>
        /// Long value, where last X numbers are decimal part. X is DecimalNumbers field from appropriated tag definition
        /// </summary>
        /// <value>Long value, where last X numbers are decimal part. X is DecimalNumbers field from appropriated tag definition</value>
        ...
        {
            return this.Equals(input as CounterTag);
        }

        /// <summary>
        /// Returns true if CounterTag instances are equal
        /// </summary>
        /// <param name="input">Instance of CounterTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CounterTag input)
        {
            if (input == null)
                return false;
