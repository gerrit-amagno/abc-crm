...
{
    /// <summary>
    /// SignatureAnnotationCreationData
    /// </summary>
    [DataContract]
    public partial class SignatureAnnotationCreationData :  IEquatable<SignatureAnnotationCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureAnnotationCreationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SignatureAnnotationCreationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureAnnotationCreationData" /> class.
        /// </summary>
        /// <param name="image">Image binary data for this annotation (required).</param>
        ...
        public SignatureAnnotationCreationData(byte[] image = default(byte[]), double height = default(double), double width = default(double), int pageNo = default(int), double startX = default(double), double startY = default(double))
        {
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new InvalidDataException("image is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Image = image;
            ...
            if (height == null)
            {
                throw new InvalidDataException("height is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Height = height;
            ...
            if (width == null)
            {
                throw new InvalidDataException("width is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.Width = width;
            ...
            if (pageNo == null)
            {
                throw new InvalidDataException("pageNo is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.PageNo = pageNo;
            ...
            if (startX == null)
            {
                throw new InvalidDataException("startX is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.StartX = startX;
            ...
            if (startY == null)
            {
                throw new InvalidDataException("startY is a required property for SignatureAnnotationCreationData and cannot be null");
            }
            else
            {
                this.StartY = startY;
        ...
        /// <summary>
        /// Image binary data for this annotation
        /// </summary>
        /// <value>Image binary data for this annotation</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureAnnotationCreationData {\n");
        ...
        {
            return this.Equals(input as SignatureAnnotationCreationData);
        }

        /// <summary>
        /// Returns true if SignatureAnnotationCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureAnnotationCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureAnnotationCreationData input)
        {
            if (input == null)
                return false;
