...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DateTagCreationData :  IEquatable<DateTagCreationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTagCreationData" /> class.
        /// </summary>
        /// <param name="tagDefinitionId">tagDefinitionId.</param>
        /// <param name="value">value.</param>
        public DateTagCreationData(Guid tagDefinitionId = default(Guid), DateTime value = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateTagCreationData {\n");
        ...
        {
            return this.Equals(input as DateTagCreationData);
        }

        /// <summary>
        /// Returns true if DateTagCreationData instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTagCreationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTagCreationData input)
        {
            if (input == null)
                return false;
