...
{
    /// <summary>
    /// SingleLineStringTagDefinition
    /// </summary>
    [DataContract]
    public partial class SingleLineStringTagDefinition :  IEquatable<SingleLineStringTagDefinition>, IValidatableObject
    {
        /// <summary>
        /// Defines SourceType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleLineStringTagDefinition" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleLineStringTagDefinition {\n");
        ...
        {
            return this.Equals(input as SingleLineStringTagDefinition);
        }

        /// <summary>
        /// Returns true if SingleLineStringTagDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleLineStringTagDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleLineStringTagDefinition input)
        {
            if (input == null)
                return false;
