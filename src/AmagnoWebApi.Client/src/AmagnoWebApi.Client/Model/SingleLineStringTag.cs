...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SingleLineStringTag :  IEquatable<SingleLineStringTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleLineStringTag" /> class.
        /// </summary>
        ...
        public SingleLineStringTag(string value = default(string), Guid id = default(Guid), Guid tagDefinitionId = default(Guid), Guid tagGroupDefinitionId = default(Guid), Guid tagGroupId = default(Guid), int insertOrder = default(int))
        {
            this.Value = value;
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SingleLineStringTag {\n");
        ...
        {
            return this.Equals(input as SingleLineStringTag);
        }

        /// <summary>
        /// Returns true if SingleLineStringTag instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleLineStringTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleLineStringTag input)
        {
            if (input == null)
                return false;
