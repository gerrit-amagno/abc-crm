...
namespace AmagnoWebApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentTypeData :  IEquatable<DocumentTypeData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTypeData" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="DocumentTypeData" /> class.
        /// </summary>
        /// <param name="documentTypeId">GUID of the document type (required).</param>
        /// <param name="singleLineStrings">Single-line text strings.</param>
        /// <param name="dates">UTCs in ISO 8601 format.</param>
        /// <param name="numbers">Long values, where last X numbers are decimal part.  X is DecimalNumbers field from appropriated tag definition.</param>
        /// <param name="selections">Selection values.</param>
        public DocumentTypeData(Guid documentTypeId = default(Guid), List<SingleLineStringTagValue> singleLineStrings = default(List<SingleLineStringTagValue>), List<DateTagValue> dates = default(List<DateTagValue>), List<NumberTagValue> numbers = default(List<NumberTagValue>), List<SelectionTagValue> selections = default(List<SelectionTagValue>))
        {
            // to ensure "documentTypeId" is required (not null)
            if (documentTypeId == null)
            {
                throw new InvalidDataException("documentTypeId is a required property for DocumentTypeData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>GUID of the document type</value>
        ...
        public List<SingleLineStringTagValue> SingleLineStrings { get; set; }
        ...
        public List<DateTagValue> Dates { get; set; }

        /// <summary>
        /// Long values, where last X numbers are decimal part.  X is DecimalNumbers field from appropriated tag definition
        /// </summary>
        /// <value>Long values, where last X numbers are decimal part.  X is DecimalNumbers field from appropriated tag definition</value>
        [DataMember(Name="numbers", EmitDefaultValue=false)]
        public List<NumberTagValue> Numbers { get; set; }
        ...
        public List<SelectionTagValue> Selections { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentTypeData {\n");
        ...
        {
            return this.Equals(input as DocumentTypeData);
        }

        /// <summary>
        /// Returns true if DocumentTypeData instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentTypeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentTypeData input)
        {
            if (input == null)
                return false;
