...
namespace AmagnoWebApi.Client.Test
{
    ...
    /// </remarks>
    public class DocumentTypesApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' DocumentTypesApi
            //Assert.IsInstanceOf(typeof(DocumentTypesApi), instance);
        }

        
        /// <summary>
        /// Test DocumentTypesGet
        /// </summary>
        [Test]
        public void DocumentTypesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid documentTypeId = null;
            //string authorization = null;
            //var response = instance.DocumentTypesGet(documentTypeId, authorization);
            //Assert.IsInstanceOf(typeof(List<TagGroupDefinition>), response, "response is List<TagGroupDefinition>");
        }
        
        /// <summary>
        /// Test DocumentTypesGetTagGroupDefinitions
        /// </summary>
        [Test]
        public void DocumentTypesGetTagGroupDefinitionsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid documentTypeId = null;
            //string authorization = null;
            //var response = instance.DocumentTypesGetTagGroupDefinitions(documentTypeId, authorization);
            //Assert.IsInstanceOf(typeof(List<TagGroupDefinition>), response, "response is List<TagGroupDefinition>");
        }
