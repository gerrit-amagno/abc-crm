...
{
    /// <summary>
    ///  Class for testing DocumentTypeCategoriesApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class DocumentTypeCategoriesApiTests
    {
        private DocumentTypeCategoriesApi instance;
        ...
        public void Init()
        {
            instance = new DocumentTypeCategoriesApi();
        }
        ...
        /// <summary>
        /// Test an instance of DocumentTypeCategoriesApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOf' DocumentTypeCategoriesApi
            //Assert.IsInstanceOf(typeof(DocumentTypeCategoriesApi), instance);
        }

        
        /// <summary>
        /// Test DocumentTypeCategoriesGetDocumentTypes
        /// </summary>
        [Test]
        public void DocumentTypeCategoriesGetDocumentTypesTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid documentTypeCategoryId = null;
            //string authorization = null;
            //var response = instance.DocumentTypeCategoriesGetDocumentTypes(documentTypeCategoryId, authorization);
            //Assert.IsInstanceOf(typeof(List<DocumentType>), response, "response is List<DocumentType>");
        }
